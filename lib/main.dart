...
import 'package:flutter_application_1/screens/HomePage.dart' as home;
import 'package:flutter_application_1/screens/ProfilePage.dart' as profile;
import 'package:flutter_application_1/screens/login_page.dart';
import 'package:flutter_application_1/screens/MyConversationsPage.dart';
import 'package:flutter_application_1/screens/MyOffersPage.dart'; // Import MyOffersPage
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      ...
      routes: {
        ...
        '/homepage': (context) => home.HomePage(apiService: ApiService()),
        ...
        '/chat': (context) {
          ...
          if (args == null ||
            ...
            throw Exception(
                'Invalid arguments for /chat route. Ensure senderId, receiverId, and receiverName are provided.');
          }
        ...
        '/my-reservations': (context) {
          final userId = ModalRoute.of(context)?.settings.arguments as int;
          return ReservationPage(
              userId: userId,
              reservationService: ReservationService(ApiService()));
          // Pointing to ReservationPage
        },
      },
    );
  }
